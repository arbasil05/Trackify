    ...
    return (
        <div className='navbar-container'>
            <Modal
                ...
                className={`custom-modal${dark ? ' dark' : ''} ${showWarning ? 'wide-modal' : 'narrow-modal'}`}
            >
                {
                    showWarning ? (
                        ...
                        <div className="upload-form-wrapper">
                            ...
                            <p style={{textAlign:'center',color:"#4880FF"}}><FontAwesomeIcon icon={faInfoCircle} /> Online courses and Open Elective courses will not be extracted</p>
                            <form className="upload-form" onSubmit={handlePdfSubmit} onKeyDown={(e) => {
